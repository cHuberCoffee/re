...
static const struct test tests[] = {
	...
	TEST(test_httpauth_digest_resp_calc_advanced),
	TEST(test_httpauth_digest_chall_decode_advanced),
	TEST(test_httpauth_digest_resp_decode_advanced),
	TEST(test_httpauth_digest_verify_advanced),
	TEST(test_ice_cand),
	TEST(test_ice_loop),
	TEST(test_jbuf),
